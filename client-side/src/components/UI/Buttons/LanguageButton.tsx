...
export const LanguageButton: FunctionComponent<LanguageButtonProps> = (props) => {
    ...
    <div className="items-center hidden h-full lg:flex">
      ...
      >
        ...
        >
          ...
          {selectedLanguage === "al" && <Image imgUrl={alFlag} name="flag_icon" styles="w-5 h-5"/>}
          {selectedLanguage === "sh" && <Image imgUrl={shFlag} name="flag_icon" styles="w-5 h-5"/>}
          {!selectedLanguage && <Icon name="BiWorld" className="group-hover:!text-white" />}
        </button>
      </Popover>
    </div>
  );
